  ...
  return (
    <section className="pb-24">
      <div className="container-icarus">
        <div className="relative overflow-hidden rounded-[2rem] border border-gold/25 bg-black/35 p-8 shadow-gold backdrop-blur-md sm:p-12 lg:p-16">
          ...
          <div className="relative max-w-4xl">
            <p className="font-display text-sm uppercase tracking-[0.35em] text-mystic/85">Crônicas futuras</p>
            <h2 className="mt-4 font-display text-3xl font-bold leading-tight text-ember sm:text-5xl">
              Um mundo moldado por divindades, lendas e escolhas
            </h2>
            <p className="mt-6 max-w-3xl text-base leading-8 text-parchment/75">

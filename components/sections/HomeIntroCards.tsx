    ...
    <section className="py-14 md:py-20">
      <div className="container-icarus">
        <div className="mx-auto max-w-3xl text-center">
          <p className="font-display text-xs uppercase tracking-[0.28em] md:text-sm md:tracking-[0.35em] text-mystic">Primeiros portais</p>
          <h2 className="mt-3 font-display text-2xl font-bold text-ember sm:text-3xl md:text-4xl">Explore os pilares do universo</h2>
        ...
        <div className="mt-10 grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3 xl:mt-12">
          {cards.map((card) => (
